                ...
                <div className="text-center py-20">
                  <div className="relative">
                    ...
                    <div className="relative bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl p-12">
                      <div className="text-white/90 text-2xl font-semibold mb-4">
                        welcome
                      </div>
                      ...
                      >
                        ...
                        <CardContent className="relative p-6">
                          <div className="flex items-start gap-4">
                            <div
                              className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold backdrop-blur-sm border ${
                                message.role === "user"
            ...
            <div className="flex-1 relative">
              ...
              <div className="relative">
                ...
                <div className="absolute right-1 top-1">
                  <div className="relative">
                    <div
                      className={`absolute -inset-0.5 rounded-lg blur-sm transition-all duration-300 ${
                    ...
                    <Button
                      ...
                      className={`relative h-10 w-10 backdrop-blur-xl border transition-all duration-300 ${
                        !input.trim() && (!files || files.length === 0)
